...
def main():
    ...
    parser.add_argument(
        "--val", type=str, default=None, help="Validation h5ad filename"
    )
    parser.add_argument(
        "--label_column", type=str, default="celltype_name", help="label column"
    )
    parser.add_argument(
        "--study_column", type=str, default="study", help="study column"
    )
    parser.add_argument(
        "--gene_order", type=str, default=None, help="gene order tsv file"
    )
